  ...
  module Profile
    class CustomCharFields
      ...
      def self.get_fields_for_viewing(char, viewer)
        return { d6: D6System.build_web_char_data(char,viewer,false) }
      end
      ...
      def self.get_fields_for_chargen(char)
        return { d6: D6System.build_web_char_data(char,char,true),
                 cg_d6: D6System.build_web_chargen_info() }
      end
      ...
      def self.save_fields_from_chargen(char, chargen_data)
        D6System.save_abilities(char, chargen_data)
        return []
      end
